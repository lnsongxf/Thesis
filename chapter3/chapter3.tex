...
\citet{AguiarBils2011} use the difference between income and spending in CEX data
...
who explain the rise in indebtedness with a limited commitment model in which the
 ...
 points out, their model produces to empirically unappealing results: for one, 
...
\end{equation*}
where $g(\theta^0, X_t^i)$ captures age effects and individual specific 
