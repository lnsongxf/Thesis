...
%\begin{table}
%\tiny
%\begin{center}\caption{Prices (Short Run), all country pairs, split sample\label{tb:prices_sr_split}}
%\input{Table_1sr}
%\end{center}
%\end{table}
%
...
%\begin{table}
%\tiny
%\begin{center}\caption{Markups (Short Run), all country pairs, split sample\label{tb:markup_sr_split}}
%\include{Table_2sr}
%\end{center}
%\end{table}
%
%\begin{table}
%\tiny
%\begin{center} \caption{Productivity (Short Run), all country pairs\label{tb:productivity_sr_split}}
%\include{Table_3sr}
%\end{center}
%\end{table}
%
%\begin{table}
%\tiny
%\begin{center}\caption{Prices (Long Run), all country pairs, split sample\label{tb:prices_lr_split}}
%\include{Table_4lr}
%\end{center}
%\end{table}
%
%\begin{table}
%\tiny
%\begin{center}\caption{Markups (Long Run), all country pairs, split sample\label{tb:markup_lr_split}}
%\include{Table_5lr}
%\end{center}
%\end{table}
%
%\begin{table}
%\tiny
%\begin{center}\caption{Productivity (Long Run), all country pairs, split sample\label{tb:productivity_lr_split}}
%\include{Table_6lr}
%\end{center}
%\end{table}